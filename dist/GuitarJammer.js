...
function GuitarJammer() {
    ...
    return (React.createElement("div", { className: "container" },
        React.createElement("div", { className: "keySelector" },
            React.createElement("h1", null, "Guitar Jammer"),
            React.createElement("label", { htmlFor: "keySelect" }, "Select a Key: "),
            React.createElement("select", { id: "keySelect", onChange: handleKeyChange, value: selectedKey },
        ...
        React.createElement("div", { className: "guitarDisplay" },
            React.createElement("img", { src: "/guitarneckimage.png", alt: "Guitar Neck", className: "guitarNeckImage" }),
            React.createElement("table", { className: "guitarNeckTable" },
                React.createElement("tbody", null, guitarNeck.map((row, rowIndex) => (React.createElement("tr", { key: rowIndex }, row.map((col, colIndex) => (React.createElement("td", { key: colIndex, style: {
                        width: fretSizes[colIndex].width,
                    } },
                    React.createElement("div", null,
                        React.createElement("span", null, guitarNotes[rowIndex][colIndex]),
                        React.createElement("span", null, col)))))))))))));
}
